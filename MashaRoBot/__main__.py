...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ Add Masha To Your Group ➕️", url="t.me/GrupCinta"),
    ],
    [
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" ℹ️ I'm *MASHA*, a powerful group management bot built to help you manage your group easily.
                 ...
                 Here is the [💾Repository](https://t.me/GrupCinta).
                 If you have any question about Masha, let us know at @GrupCinta.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *MASHA*
                 \nHere is the [Source Code](https://t.me/GrupCinta) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=False,
            reply_markup=InlineKeyboardMarkup(
                [
